...
export const exampleUniversities: University[] = [
 ...
 // { name: 'Universidad de Ejemplo', shortName: 'U Ejemplo', logo: images.logoUNAQ, url: 'https://www.ejemplo.com', type: 'publica', coordinates: [20.5880, -100.3880] },
  ...
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS SAN JUAN DEL RIO', shortName: 'UAQ Campus SJR', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos#', type: 'publica', coordinates: [20.389102169969977, -99.972141728836] },
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS JALPAN', shortName: 'UAQ Campus Jalpan', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [21.21699700479592, -99.46051130000002] },
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS AMEALCO', shortName: 'UAQ Campus AMEALCO', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.17508444109657, -100.1370746288359] },
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CADEREYTA', shortName: 'UAQ Campus Cadereyta', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.712830235376316, -99.8413685] },
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS TEQUISQUIAPAN', shortName: 'UAQ Campus Tequisquiapan', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.516738044915247, -99.90231297116414] },
...
//Agronomia y Vererinaria
  ...
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS AEROPUERTO', shortName: 'UAQ Campus AEROPUERTO', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.624500123645078, -100.36863564232824] },
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO HISTORICO', shortName: 'UAQ Campus Centro Historico', logo: images.logoUA, logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.595155864633274, -100.38871068280528] },
  ...
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CORREGIDORA', shortName: 'UAQ Campus Corregidora', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.557662182468217, -100.42053217116413] },
  { name: 'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS LA CAPILLA', shortName: 'UAQ Campus La Capilla', logo: images.logoUAQ, url: 'https://www.uaq.mx/index.php/oferta-educativa/programas-educativos', type: 'publica', coordinates: [20.5799191, -100.41074152883589] },
  ...
  { name: 'CENTRO UNIVERSITARIO INTERNACIONAL DE MEXICO, CAMPUS QUERETARO', shortName: 'UAQ Campus Queretaro', logo: images.U_CU, url: 'https://cuin.edu.mx/', type: 'privada', coordinates: [20.598788414183467, -100.4003362] },
