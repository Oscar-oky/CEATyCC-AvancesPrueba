...
export const exampleUniversities: University[] = [
  { name: 'Universidad de Ejemplo', shortName: 'U Ejemplo', logo: images.logoUNAQ, url: 'https://www.ejemplo.com', type: 'privada', careers: ['Carrera de Ejemplo 1'], coordinates: [20.5880, -100.3880] },
  { name: 'TECNOLÓGICO NACIONAL DE MÉXICO, CAMPUS QUERÉTARO', shortName: 'TECNM QRO', logo: images.logoTECNM, url: 'https://queretaro.tecnm.mx', type: 'tecnologica', careers: ['Carrera de Ejemplo 1'], coordinates: [20.59329800000002, -100.40570047472707] },
