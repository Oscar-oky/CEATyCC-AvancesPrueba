...
const TorneoProgramacionAvanzado: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    formData.append('event_type', 'prog_avanzado');
  ...
  const fetchPhotos = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/concurso-carteles-images?event_type=prog_avanzado`);
      if (!response.ok) {
        ...
        <div className="space-y-6">
          ...
          {isAdmin() && (
            ...
            >
              ...
              <div className="text-center">
                <span className="font-semibold text-xl block">Selecciona tus fotos del Torneo Avanzado</span>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <img
                          src={photo.url}
                          alt={`Torneo Avanzado ${globalIndex + 1}`}
            ...
            <div className="bg-white w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl border border-gray-100 flex flex-col max-h-[95vh]">
              ...
              <div className="bg-blue-600 px-8 py-5 flex items-center justify-between text-white">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold">Galería - Torneo de Programación Avanzada</h3>
                  ...
                  <>
                    ...
                    >
                      ...
                      <img
                        ...
                        alt={`Torneo Avanzado ${selectedPhotoIndex + 1}`}
              ...
              <div className="bg-gray-50 px-8 py-4 text-xs font-mono text-gray-400 flex justify-between items-center">
                <div>Torneo de Programación Avanzada 2025</div>
