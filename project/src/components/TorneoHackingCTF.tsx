...
const TorneoHackingCTF: React.FC = () => {
  ...
  // Al abrir la galería, establecer la categoría por defecto como "Torneo de Hacking CTF"
  ...
  const sections = [
    {
      title: 'Introducción',
      icon: BookOpen,
      content: 'Aquí va una breve introducción sobre el Torneo de Hacking CTF, su propósito y a quién está dirigido. Se destacará la importancia de la participación y el aprendizaje en un ambiente competitivo y amigable.',
    },
    {
      title: 'Bases del Concurso',
      icon: ListChecks,
      content: 'En esta sección se detallarán las reglas y el formato del Torneo de Hacking CTF. Se explicará cómo serán los desafíos, las herramientas permitidas y las normativas que todos los participantes deben seguir.',
    },
    {
      title: 'Participantes',
      icon: Users,
      content: (
        <>
          Información sobre el perfil de los participantes. Por ejemplo, estudiantes con conocimientos en ciberseguridad, requisitos de inscripción, si es individual o en equipos, y el número máximo de participantes.
          <br /><br />
    ...
    },
    {
      title: 'Temáticas',
      icon: Trophy,
      content: 'Se describirán los temas o áreas de conocimiento que abarcarán los desafíos del CTF, como criptografía, reversing, forense, web exploitation, etc.',
    },
    {
      title: 'Fechas Importantes',
      icon: Calendar,
      content: 'Un cronograma con las fechas clave del evento: fecha límite de inscripción, fecha del CTF, y fecha de la premiación.',
    },
    {
      title: 'Requisitos',
      icon: Star,
      content: 'Listado de requisitos técnicos y académicos para poder participar. Por ejemplo, ser estudiante activo, tener conocimientos básicos de ciberseguridad, y contar con un equipo de cómputo.',
    },
    {
      title: 'Proceso de Evaluación y Premios',
      icon: Award,
      content: 'Explicación de cómo se evaluarán las soluciones a los desafíos, los criterios de desempate y una descripción de los premios para los ganadores (diplomas, premios en especie, etc.).',
    },
    {
