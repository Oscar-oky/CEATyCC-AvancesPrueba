...
const EstanciasEstadias: React.FC = () => {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Estancias y Estadías</h1>
      
      {selectedUniversity === null ? (
        <div>
          <p className="text-center text-lg text-gray-600 mb-10">
            Selecciona una universidad para ver la información sobre estancias y estadías.
          </p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="space-y-8">
            {selectedData?.shortName === 'UPSRJ' ? (
              <>
                <div>
                  <h3 className="text-xl font-semibold mb-4 border-b-2 border-blue-500 pb-2 text-gray-700">Estancias y Estadías Profesionales</h3>
                  <p className="text-gray-600 mb-4">
                    Para la Universidad Politécnica de Santa Rosa Jáuregui (UPSRJ), el proceso de Estancias y Estadías Profesionales es fundamental debido a su modelo basado en competencias y su enfoque bilingüe.
                  </p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <h4 className="text-lg font-semibold mb-3 text-gray-700">Estructura del Programa</h4>
                  <div className="flex justify-center mb-4">
                    <img 
                      src="https://i.imgur.com/example.png" 
                      alt="Estructura de Estancias y Estadías UPSRJ" 
                      className="max-w-full h-auto rounded-lg shadow-md"
                    />
                  </div>
                  <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="bg-green-100 text-green-800 font-bold py-2 px-4 rounded">4° Cuatrimestre</div>
                      <div>
                        <p className="text-sm font-medium">Medio tiempo*</p>
                        <p className="text-xs text-gray-600">Una vez cursadas las materias marcadas en los cuatrimestres del 1 al 3</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="bg-blue-100 text-blue-800 font-bold py-2 px-4 rounded">7° Cuatrimestre</div>
                      <div>
                        <p className="text-sm font-medium">Medio Tiempo*</p>
                        <p className="text-xs text-gray-600">Una vez cursadas las materias marcadas en los cuatrimestres del 1 al 6</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="bg-purple-100 text-purple-800 font-bold py-2 px-4 rounded">11° Cuatrimestre</div>
                      <div>
                        <p className="text-sm font-medium">600 horas</p>
                        <p className="text-xs text-gray-600">Una vez cursadas las materias marcadas en los cuatrimestres del 1 al 10</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <>
                <div>
                  <h3 className="text-xl font-semibold mb-4 border-b-2 border-blue-500 pb-2 text-gray-700">Estancias y Estadías Profesionales</h3>
                  <p className="text-gray-600 mb-4">
                    Para la Universidad Politécnica de Querétaro (UPQ), el proceso de Estancias y Estadías es el pilar de su modelo educativo "Triple Hélice".
                  </p>
              ...
              <>
                <div>
                  <h3 className="text-xl font-semibold mb-4 border-b-2 border-blue-500 pb-2 text-gray-700">Estancias y Estadías Profesionales</h3>
                  <p className="text-gray-600 mb-4">
                    Para la Universidad Tecnológica de Corregidora (UTC), el proceso de estancias y estadías es fundamental debido a su enfoque en el desarrollo regional y sustentable.
                  </p>
                  ...
                  <h4 className="text-lg font-semibold mb-3 text-gray-700">2. Estructura de las Estancias y Estadías en la UTC</h4>
                  <div className="space-y-3 mb-4">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">El alumno debe realizar una Memoria de Estancia/Estadía que es una propuesta de mejora técnica o administrativa. Se asignan dos asesores para validar el rigor científico y práctico del proyecto.</p>
                    </div>
                    <div>
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-1">
                    ...
                    <li>Turismo y Tecnologías de la Información: Estancias y estadías enfocadas en servicios y desarrollo de software.</li>
                  </ul>
                </div>
              </>
              ...
              <>
                <div>
                  <h3 className="text-xl font-semibold mb-4 border-b-2 border-blue-500 pb-2 text-gray-700">Estancias y Estadías Profesionales</h3>
                  <p className="text-gray-600 mb-4">
                    Para la Universidad Tecnológica de Querétaro (UTEQ), el proceso de estancias y estadías es el cierre de dos etapas formativas diferentes, con un enfoque en la formación práctica y el Modelo Dual Alemán.
                  </p>
                  ...
                  <h4 className="text-lg font-semibold mb-3 text-gray-700">2. Estructura de las Estancias y Estadías (Modelo Académico)</h4>
                  <div className="space-y-3 mb-4">
                    <div>
                      <p className="font-medium text-gray-700">Etapas Formativas:</p>
                      <ul className="list-disc list-inside text-gray-600 ml-4">
                        <li><strong>Estancia/Estadía de TSU:</strong> Se realiza al finalizar el 6to cuatrimestre.</li>
                        <li><strong>Estancia/Estadía de Ingeniería:</strong> Se realiza al finalizar el 11vo cuatrimestre.</li>
                      </ul>
                    </div>
                    <div>
                      <p className="font-medium text-gray-700">Duración:</p>
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Desarrollar una Memoria de Estancia/Estadía que documente la solución a una problemática industrial real, lo cual es el requisito único para la titulación.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="font-medium text-gray-700">Modelo Dual:</p>
                      <p className="text-gray-600">La UTEQ es pionera en el Modelo Dual Alemán, donde los estudiantes pasan gran parte de su formación dentro de la empresa, no solo en la estancia/estadía final.</p>
                    </div>
                    <div>
                      <p className="font-medium text-gray-700">Centros de Innovación:</p>
                      <p className="text-gray-600">Muchos alumnos realizan sus estancias/estadías dentro del Centro de Innovación y Creatividad (CIC), colaborando en proyectos tecnológicos con socios como Microsoft y Siemens.</p>
                    </div>
                    <div>
              ...
              <>
                <div>
                  <h3 className="text-xl font-semibold mb-4 border-b-2 border-blue-500 pb-2 text-gray-700">Estadías</h3>
              ...
              <>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Estadías</h3>
                  <p className="text-gray-600">
                    Aquí se mostrará la información detallada sobre las estadías profesionales para {selectedData?.shortName}. 
                    Esto puede incluir proyectos disponibles, perfiles buscados, duración y cómo postularse.
                    Por el momento, esta sección está en construcción.
                  </p>
                </div>
              </>
...
export default EstanciasEstadias;
