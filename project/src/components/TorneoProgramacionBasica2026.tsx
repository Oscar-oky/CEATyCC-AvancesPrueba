...
const TorneoProgramacionBasica: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    formData.append('event_type', 'prog_basico_2026');
  ...
  const fetchPhotos = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/concurso-carteles-images?event_type=prog_basico_2026`);
      if (!response.ok) {
        ...
        <div className="space-y-6">
          ...
          {isAdmin() && (
            ...
            <input
              ...
              className="hidden"
              id="file-upload-basico-2026"
            />
            <label
              htmlFor="file-upload-basico-2026"
            ...
            >
              ...
              <div className="text-center">
                <span className="font-semibold text-xl block">Selecciona tus fotos del Torneo Básico 2026</span>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <img
                          src={photo.url}
                          alt={`Torneo Básico 2026 ${globalIndex + 1}`}
            ...
            <div className="bg-white w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl border border-gray-100 flex flex-col max-h-[95vh]">
              ...
              <div className="bg-blue-600 px-8 py-5 flex items-center justify-between text-white">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold">Galería - Torneo de Programación Básica 2026</h3>
                  ...
                  <>
                    ...
                    >
                      ...
                      <img
                        ...
                        alt={`Torneo Básico 2026 ${selectedPhotoIndex + 1}`}
              ...
              <div className="bg-gray-50 px-8 py-4 text-xs font-mono text-gray-400 flex justify-between items-center">
                <div>Torneo de Programación Básica 2026</div>
