              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
                {Universidades_Logo.map((uni, index) => (
                  ...
                  >
                    ...
                    <span className="mt-4 text-sm font-bold tracking-wider text-gray-500 group-hover:text-green-600 transition-colors uppercase">
                      {uni.shortName}
                    </span>
                  </motion.div>
                ))}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                  <div className="bg-white rounded-3xl p-8 sm:p-10 border border-gray-200 shadow-sm">
                    ...
                    {/* Fallback for others */}
                    {!['UPSRJ', 'UPQ', 'UNAQ'].includes(selectedUniversity || '') && (
                      <div className="text-center py-20 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                        <Info className="w-12 h-12 text-gray-300 mx-auto mb-4" />
                        <h3 className="text-xl font-bold text-gray-700 mb-2">Detalles en actualización</h3>
                        <p className="text-gray-500 max-w-sm mx-auto">
                          Estamos migrando la información técnica de estadías para {selectedData?.shortName}. Consulta con el área de vinculación de tu plantel.
                        </p>
                      </div>
                    )}
                  </div>
