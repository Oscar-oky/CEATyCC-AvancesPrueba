...
const Estadias: React.FC = () => {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Estadías</h1>
      
      {selectedUniversity === null ? (
        <div>
          <p className="text-center text-lg text-gray-600 mb-10">
            Selecciona una universidad para ver la información sobre estadías.
          </p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="space-y-8">
            {selectedData?.shortName === 'UPSRJ' ? (
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Estadías Profesionales</h3>
                <p className="text-gray-600 mb-4">
                  Para la Universidad Politécnica de Santa Rosa Jáuregui (UPSRJ), el proceso de Estadías Profesionales es fundamental debido a su modelo basado en competencias y su enfoque bilingüe.
                </p>
                
                <h4 className="text-lg font-semibold mb-3 text-gray-700">1. Directorio de Contacto (Vinculación)</h4>
                <p className="text-gray-600 mb-4">
                  El área encargada de coordinar las estadías es la Secretaría de Vinculación.
                </p>
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Muchos estudiantes realizan sus estadías en inglés, ya que la UPSRJ es una universidad Bilingüe, Internacional y Sustentable.</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-700">Inclusión:</p>
                    <p className="text-gray-600">La UPSRJ destaca por su Programa de Inclusión, por lo que las estadías también están adaptadas para estudiantes con discapacidad motriz, visual o auditiva.</p>
                  </div>
                </div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Estadías Profesionales</h3>
                <p className="text-gray-600 mb-4">
                  Para la Universidad Politécnica de Querétaro (UPQ), el proceso de Estadías es el pilar de su modelo educativo "Triple Hélice".
                </p>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Estadías Profesionales</h3>
                <p className="text-gray-600 mb-4">
                  Para la Universidad Tecnológica de Corregidora (UTC), el proceso de estadías es fundamental debido a su enfoque en el desarrollo regional y sustentable.
                </p>
                ...
                <h4 className="text-lg font-semibold mb-3 text-gray-700">2. Estructura de las Estadías en la UTC</h4>
                <div className="space-y-3 mb-4">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">El alumno debe realizar una Memoria de Estadía que es una propuesta de mejora técnica o administrativa. Se asignan dos asesores para validar el rigor científico y práctico del proyecto.</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-700">Seguro Facultativo:</p>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  ...
                  <li>Turismo y Tecnologías de la Información: Estadías enfocadas en servicios y desarrollo de software.</li>
                </ul>
              </div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Estadías Profesionales</h3>
                <p className="text-gray-600 mb-4">
                  Para la Universidad Tecnológica de Querétaro (UTEQ), el proceso de estadías es el cierre de dos etapas formativas diferentes, con un enfoque en la formación práctica y el Modelo Dual Alemán.
                </p>
                ...
                <h4 className="text-lg font-semibold mb-3 text-gray-700">2. Estructura de las Estadías (Modelo Académico)</h4>
                <div className="space-y-3 mb-4">
                  <div>
                    <p className="font-medium text-gray-700">Etapas Formativas:</p>
                    <ul className="list-disc list-inside text-gray-600 ml-4">
                      <li><strong>Estadía de TSU:</strong> Se realiza al finalizar el 6to cuatrimestre.</li>
                      <li><strong>Estadía de Ingeniería:</strong> Se realiza al finalizar el 11vo cuatrimestre.</li>
                    </ul>
                  </div>
                  <div>
                    <p className="font-medium text-gray-700">Duración:</p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Desarrollar una Memoria de Estadía que documente la solución a una problemática industrial real, lo cual es el requisito único para la titulación.</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="font-medium text-gray-700">Modelo Dual:</p>
                    <p className="text-gray-600">La UTEQ es pionera en el Modelo Dual Alemán, donde los estudiantes pasan gran parte de su formación dentro de la empresa, no solo en la estadía final.</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-700">Centros de Innovación:</p>
                    <p className="text-gray-600">Muchos alumnos realizan sus estadías dentro del Centro de Innovación y Creatividad (CIC), colaborando en proyectos tecnológicos con socios como Microsoft y Siemens.</p>
                  </div>
                  <div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Residencia Profesional</h3>
                <p className="text-gray-600 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-2 border-green-500 pb-2 text-gray-700">Prácticas Profesionales</h3>
                <p className="text-gray-600 mb-4">
