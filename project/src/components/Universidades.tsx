...
const categories: Category[] = [
  ...
  },*/
  {
    ...
    careers: [
      ...
      'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS JALPAN',
      'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS AMEALCO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CADEREYTA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS TEQUISQUIAPAN',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO UNIVERSITARIO',
      'ESCUELA NACIONAL DE ESTUDIOS SUPERIORES, UNIDAD JURIQUILLA',

      //Universidades Privadas
      'UNIVERSIDAD MONDRAGÓN MÉXICO',
      'UNIVERSIDAD MESOAMERICANA PLANTEL SAN JUAN, S. C.',
      'UNIVERSIDAD ALFRED NOBEL DE MEXICO',
      'UNIVERSIDAD MARISTA DE QUERETARO, A. C.',
      'UNIVERSIDAD CUAUHTÉMOC, PLANTEL QUERÉTARO',
      'CENTRO DE ESTUDIOS SUPERIORES DEL BAJIO CAMPUS QUERETARO',
      'UNIVERSIDAD DEL GOLFO DE MEXICO, CAMPUS QUERETARO',
      'UNIVERSIDAD DE ESTUDIOS AVANZADOS, CAMPUS QUERETARO',
      'UNIVERSIDAD DE LONDRES',
      'UNIVERSIDAD ANAHUAC',
      'INSTITUTO DE ESTUDIOS SUPERIORES ISIMA PLANTEL QUERETARO',
      'UNIVERSIDAD TEC MILENIO QUERETARO',
      'UNIVERSIDAD DEL DESARROLLO PROFESIONAL PLANTEL QUERETARO',
      'INSTITUTO SANJUANENSE DE ESTUDIOS SUPERIORES, A.C.',
      'UNIVERSIDAD MARISTA DE QUERETARO, CAMPUS SAN JUAN DEL RIO',
      'ESCUELA BANCARIA Y COMERCIAL CAMPUS QUERETARO',
      'INSTITUTO DE FORMACION EDUCATIVA SUPERIOR, PLANTEL SAN JUAN DEL RIO',
      'ATENAS, ESTUDIOS SUPERIORES',
      'CENTRO DE ESTUDIOS INTERNACIONAL DE QUERETARO',
      'COLEGIO UNIVERSITARIO DE HUMANIDADES',
      'UNIVERSIDAD CENTRAL DE QUERETARO',
      'INSTITUTO UNIVERSITARIO DEL CENTRO DE MEXICO CAMPUS QUERETARO',
      'UNIVERSIDAD DEL VALLE DE ATEMAJAC PLANTEL QUERETARO',
      'CENTRO DE ESTUDIOS UNIVERSITARIOS DE QUERETARO A.C.',
      'UNIVERSIDAD LA PROVIDENCIA',
      'INSTITUTO UNIVERSITARIO DEL CENTRO DE MEXICO CAMPUS SAN JUAN DEL RIO',
      ...
      'UNIVERSIDAD OMI CENTRO DE INVESTIGACION, SAN JUAN DEL RIO',
      'CENTRO CULTURAL UNIVERSITARIO DE INVESTIGACION FORENSE Y JURIDICA',
      'UNIVERSIDAD PRIVADA DEL BAJIO',
      'COLEGIO INTERNACIONAL DE ESTUDIOS VIRTUALES',
      'CENTRO UNIVERSITARIO DE EMPRENDEDORES',
      'INSTITUTO ESGA',
      'INSTITUTO UNIVERSITARIO DE DESARROLLO HUMANO E INNOVACION PROFESIONAL (IDHEIP)',
      'INSTITUTO INTERAMERICANO DE CIENCIAS DE LA SALUD',
      'INSTITUTO DE DESARROLLO E INNOVACIÓN EMPRENDE',
      'UNIVERSIDAD TECNOLOGICA AMERICANA, CAMPUS QUERETARO',
      'UNIVERSIDAD DE LAS MUJERES',
      'TECNOLÓGICO UNIVERSITARIO QUERÉTARO',
      'INSTITUTO UNIVERSITARIO UNIEM',
      'ESCUELA LIBRE DE NEGOCIOS',
      'CORPORATIVO INTERNACIONAL UNIVERSITARIO CAMPUS SAN JUAN DEL RIO',
      'CENTRO UNIVERSITARIO REAL DE QUERETARO',
      'INSTITUTO UNIVERSITARIO DEL CENTRO DE MEXICO CAMPUS CADEREYTA',
  ...
  },
  {
    ...
    careers: [
      'UNIVERSIDAD TECNOLOGICA DE QUERETARO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS CONCA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO UNIVERSITARIO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS JURIQUILLA',
      'CENTRO UNIVERSITARIO CEICKOR',
      'INSTITUTO TECNOLOGICO DE ESTUDIOS SUPERIORES DE MONTERREY "UNIDAD QUERETARO"',
    ],
  },
  {
    ...
    careers: [
      'COLEGIO NACIONAL DE DANZA CONTEMPORANEA',
      'UNIVERSIDAD TECNOLOGICA DE QUERETARO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS SAN JUAN DEL RIO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS AEROPUERTO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO HISTORICO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO UNIVERSITARIO',
      'UNIVERSIDAD MONDRAGÓN MÉXICO',
      'UNIVERSIDAD MESOAMERICANA PLANTEL SAN JUAN, S. C.',
      'UNIVERSIDAD MARISTA DE QUERETARO, A. C.',
      ...
      'UNIVERSIDAD ANAHUAC',
      'MUSIC CITY COLLEGE',
      'CONSERVATORIO DE MUSICA "JOSE GUADALUPE VELAZQUEZ"',
      'UNIVERSIDAD TEC MILENIO QUERETARO',
      'UNIVERSIDAD DEL DESARROLLO PROFESIONAL PLANTEL QUERETARO',
      ...
      'UNIVERSIDAD DE LAS CIENCIAS JURIDICAS Y SOCIALES',
      'UNIVERSIDAD TECNOLOGICA DE MEXICO',
  ...
  },
  {
    ...
    careers: [
     ...
     'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS SAN JUAN DEL RIO',
     'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS JALPAN',
     'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CORREGIDORA',
     'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO UNIVERSITARIO',
     'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS JURIQUILLA',
     'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS LA CAPILLA',
     'ESCUELA NACIONAL DE ESTUDIOS SUPERIORES, UNIDAD JURIQUILLA',
     'CENTRO DE ESTUDIOS SUPERIORES DEL BAJIO CAMPUS QUERETARO',
     'UNIVERSIDAD ANAHUAC',
     'INSTITUTO DE REHABILITACION DE QUERETARO',
     'UNIVERSIDAD DEL DESARROLLO PROFESIONAL PLANTEL QUERETARO',
     'INSTITUTO INTERAMERICANO DE CIENCIAS DE LA SALUD',
     'UNIVERSIDAD CENTRAL DE QUERETARO',
     'UNIVERSIDAD DEL VALLE DE ATEMAJAC PLANTEL QUERETARO',
     'UNIVERSIDAD CUAUHTÉMOC, PLANTEL QUERÉTARO',
     'UNIVERSIDAD TECNOLOGICA DE MEXICO',
     'SISTEMA EDUCATIVO CUIEP CAMPUS SAN JUAN DEL RIO',
     'UNIVERSIDAD OMI CENTRO DE INVESTIGACION, SAN JUAN DEL RIO',
  ...
  },
  {
    ...
    careers: [
      ...
      'UNIVERSIDAD INTERGLOBAL',
      'UNIVERSIDAD TECNOLOGICA DE MEXICO',
      'COLEGIO DE CIENCIAS Y HUMANIDADES DE QUERETARO',
      'UNIPLEA',
      'SISTEMA EDUCATIVO CUIEP CAMPUS SAN JUAN DEL RIO',
      'CENTRO DE ESTUDIOS SUPERIORES CONIN',
      'INSTITUTO UNIVERSITARIO UCAP DEL BAJÍO',
      'UNIVERSIDAD OMI CENTRO DE INVESTIGACION, SAN JUAN DEL RIO',
      'CENTRO CULTURAL UNIVERSITARIO DE INVESTIGACION FORENSE Y JURIDICA',
      'INSTITUTO UNIVERSITARIO DEL CENTRO DE MEXICO, CAMPUS AMEALCO DE BONFIL',
      'UNIVERSIDAD PRIVADA DEL BAJIO',
      'COLEGIO INTERNACIONAL DE ESTUDIOS VIRTUALES',
      'CENTRO UNIVERSITARIO DE EMPRENDEDORES',
      'INSTITUTO ESGA',
  ...
  },
  {
    ...
    careers: [
      ...
      'CENTENARIA Y BENEMERITA ESCUELA NORMAL DEL ESTADO DE QUERETARO ANDRES BALVANERA JALPAN DE SERRA',
      'CENTENARIA Y BENEMERITA ESCUELA NORMAL DEL ESTADO DE QUERETARO ANDRES BALVANERA SAN JUAN DEL RIO',
      'UNIVERSIDAD TECNOLOGICA DE QUERETARO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS SAN JUAN DEL RIO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CORREGIDORA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS AEROPUERTO',
      ...
      'INSTITUTO LA PAZ DE QUERETARO, A.C.',
      'UNIVERSIDAD MONDRAGÓN MÉXICO',
      'UNIVERSIDAD MESOAMERICANA PLANTEL SAN JUAN, S. C.',
      'UNIVERSIDAD ALFRED NOBEL DE MEXICO',
      'UNIVERSIDAD MARISTA DE QUERETARO, A. C.',
  ...
  },
  {
    ...
    careers: [
      ...
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS SAN JUAN DEL RIO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS AMEALCO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS AMAZCALA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS AEROPUERTO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS TEQUISQUIAPAN',
      'UNIVERSIDAD AUTONOMA DE QUERETARO CAMPUS CONCA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO UNIVERSITARIO',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS PINAL DE AMOLES',
      'ESCUELA NACIONAL DE ESTUDIOS SUPERIORES, UNIDAD JURIQUILLA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS PEDRO ESCOBEDO',
      'UNIVERSIDAD MONDRAGÓN MÉXICO',
      'UNIVERSIDAD MESOAMERICANA PLANTEL SAN JUAN, S. C.',
      'UNIVERSIDAD MARISTA DE QUERETARO, A. C.',
      'CENTRO DE ESTUDIOS SUPERIORES DEL BAJIO CAMPUS QUERETARO',
      ...
      'UNIVERSIDAD MARISTA DE QUERETARO, CAMPUS SAN JUAN DEL RIO',
      'INSTITUTO DE FORMACION EDUCATIVA SUPERIOR, PLANTEL SAN JUAN DEL RIO',
      'CENTRO UNIVERSITARIO INTERNACIONAL DE MEXICO, CAMPUS QUERETARO',
      'UNIVERSIDAD CENTRAL DE QUERETARO',
      'UNIVERSIDAD DEL VALLE DE ATEMAJAC PLANTEL QUERETARO',
      'INSTITUTO UNIVERSITARIO DEL CENTRO DE MEXICO CAMPUS SAN JUAN DEL RIO',
      'UNIVERSIDAD CUAUHTÉMOC, PLANTEL QUERÉTARO',
  ...
  },
  {
    ...
    careers: [
      ...
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS CENTRO UNIVERSITARIO',
      'UNIVERSIDAD MONDRAGÓN MÉXICO',
      'INSTITUTO GASTRONOMICO DE ESTUDIOS SUPERIORES, S. C.',
      'UNIVERSIDAD ANAHUAC',
      'INSTITUTO DE ESTUDIOS SUPERIORES ISIMA PLANTEL QUERETARO',
      'INSTITUTO CULINARIO DE QUERETARO',
      'CENTRO DE ESTUDIOS INTERNACIONAL DE QUERETARO',
      'UNIVERSIDAD TECNOLOGICA DE MEXICO',
      'INSTITUTO DE ESTUDIOS SUPERIORES LAUSANNE',
    ],
  },
  {
    ...
    careers: [
      ...
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS JURIQUILLA',
      'ESCUELA NACIONAL DE ESTUDIOS SUPERIORES, UNIDAD JURIQUILLA',
      'UNIVERSIDAD AUTONOMA DE QUERETARO, CAMPUS COLON',
      'UNIVERSIDAD MONDRAGÓN MÉXICO',
      'UNIVERSIDAD ALFRED NOBEL DE MEXICO',
      'UNIVERSIDAD MARISTA DE QUERETARO, A. C.',
      'CENTRO DE ESTUDIOS SUPERIORES DEL BAJIO CAMPUS QUERETARO',
