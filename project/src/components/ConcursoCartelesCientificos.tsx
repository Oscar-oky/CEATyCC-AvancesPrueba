        ...
        <div className="space-y-6">
          ...
          {photos.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-2xl font-bold text-gray-400">Aún no hay carteles en la galería</p>
            </div>
          )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sections.map((section) => (
            <div key={section.title} className="bg-white rounded-3xl shadow-xl overflow-hidden transform hover:-translate-y-1 transition-all duration-300">
              <div className="p-8">
                <div className="flex items-center">
                  <section.icon className="h-9 w-9 text-blue-500" />
          ...
          <div className="bg-white w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl border border-gray-100 flex flex-col max-h-[95vh]">
            ...
            <div className="bg-blue-600 px-8 py-5 flex items-center justify-between text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-2xl font-bold">Galería de Carteles</h3>
                  <p className="text-blue-200 text-sm -mt-1">Fotos de Edición • {photos.length} carteles</p>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-white relative min-h-[500px]">
              {photos.length > 0 ? (
                ...
                <div className="text-center text-gray-300">
                  ...
                  <p className="text-2xl font-bold">Aún no hay carteles en la galería</p>
                  <p className="mt-2">¡Sube el primero!</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-50 px-8 py-4 text-xs font-mono text-gray-400 flex justify-between items-center">
              <div>Concurso de Carteles Científicos 2026</div>
