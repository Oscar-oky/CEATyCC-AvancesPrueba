...
--
-- Host: localhost
-- Generation Time: Mar 27, 2026 at 02:31 PM
...
--
-- Table structure for table `concurso_carteles_images`
--

CREATE TABLE `concurso_carteles_images` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `concurso_carteles_images`
--
ALTER TABLE `concurso_carteles_images`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `concurso_carteles_images`
--
ALTER TABLE `concurso_carteles_images`
